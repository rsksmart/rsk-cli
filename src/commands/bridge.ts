...
function logMessage(params: BridgeCommandOptions, message: string, color: any = chalk.white) {
...
function startSpinner(params: BridgeCommandOptions, spinner: any, message: string) {
  if (!params.isExternal) {
...
function succeedSpinner(params: BridgeCommandOptions, spinner: any, message: string) {
  if (!params.isExternal) {
    spinner.succeed(message);
  }
}

function failSpinner(params: BridgeCommandOptions, spinner: any, message: string) {
  if (!params.isExternal) {
